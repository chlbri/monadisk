...
> = Parameters<T[K]>[0];
export declare type Subscriber<I = any, O = any> = (
  input: I,
  output: O,
) => unknown;
...
export declare type Mapper<T extends Def = Def, R = any> = (
  | _Mapper<T, R>
  | Partial<_Mapper<T, R>>
) & {
  else: (data?: Param<T>) => R;
...
export declare type LastOf<T extends ReadonlyArray<any>> =
  T['length'] extends 0 | 1 ? T[0] : T extends [any, infer U] ? U : never;
export {};
