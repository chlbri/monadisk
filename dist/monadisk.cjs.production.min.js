...
var t = require('util').promisify(setTimeout);
function e() {
  e = function () {
    return t;
  };
  ...
  v = (function () {
    function t(e, r) {
      ...
      Object.defineProperty(this, u, { writable: !0, value: void 0 }),
        ...
        (a(this, c)[c] = []),
        (a(this, h)[h] = function () {
          var t = { input: n.current, output: a(n, f)[f] };
          a(n, u)[u].push(t);
        }),
        (a(this, l)[l] = function () {
          a(n, c)[c].forEach(function (t) {
            return t(n.current, a(n, f)[f]);
          });
        }),
        (a(this, p)[p] = function (t) {
          var e = t.else;
          if (n.isUndefined) return e(n.current);
          for (var r = 0, o = Object.entries(n.def); r < o.length; r++) {
            var i = o[r],
              a = t[i[0]],
              u = (0, i[1])(n.current);
            if (a && u) return a(n.current);
          }
          return e(n.current);
        }),
        ...
        (this.setMapper = function (t) {
          a(n, s)[s] = t;
        }),
        (this.merge = function (e, r) {
          var o = r ? a(n, p)[p](r) : e.current;
          return new t(e.def, o);
        }),
        (this.next = function () {
          for (
          ...
          e.forEach(function (t) {
            (n.current = t), n.transform(a(n, s)[s]);
          });
        });
    }
    var e, r;
    return (
      (t.prototype.transform = function (t, e) {
        return (
          void 0 === e && (e = !0),
          this.setMapper(t),
          (a(this, f)[f] = a(this, p)[p](a(this, s)[s])),
          a(this, h)[h](),
          e && a(this, l)[l](),
          a(this, f)[f]
        );
...
g(),
  ...
  (exports.main = g),
  (exports.sleep = t),
  (exports.sum = function (t, e) {
    return t + e;
  });
//# sourceMappingURL=monadisk.cjs.production.min.js.map
